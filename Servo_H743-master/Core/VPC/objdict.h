...
static const std::map<int, void *> objdict{
    ...
    {0x50f007, &servo.sample.p2_index},
		...
		{0x603F00, &servo.Error_code},
    {0x606000, &servo.Modes_of_operation},
		{0x607100, &servo.iq_d},
		
		{0x607900, &servo.PPM_mode},
		{0x607A00, &servo.pos_d},
		{0x607D00, &servo.safeguard.countMax},
		{0x607E00, &servo.safeguard.busVoltage_V},
		{0x608100, &servo.PPM_Vel},
		{0x608000, &servo.encoder.speed_rpm_max},
		{0x608300, &servo.PPM_acc},
		{0x608400, &servo.PPM_dec},
		{0x608700, &servo.PTM_acc},
		{0x60FF00, &servo.speed_d},
